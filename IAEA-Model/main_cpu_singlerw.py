...
from singleRLrewriter.model import Rewriter
from singleRLrewriter.decode import BeamSearchDecoder
import singleRLrewriter.run_rewriter as run_rewriter
...
tf.app.flags.DEFINE_boolean('embedding', False, 'path to the pre-trained embedding file')
