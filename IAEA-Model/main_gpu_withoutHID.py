...
# author: ouyangzhichao date:8.10
# 8月10号 tkdd修改版本
# HID的数据集拿去增大了，同步论文里的数据，现在放在gpu上跑，不在是之前的cpu


# 最终用到的 end2end -> lr=0.005
import os
...
import pprint
import time
from selector_gpu_withoutHID.model import SentenceSelector
from selector_gpu_withoutHID.evaluate import SelectorEvaluator
import selector_gpu_withoutHID.run_selector as run_selector
