...
tokenized_twitter_dir = "twitter_train_tokenized_3m10"    # 分词后存的路径
# cnn_tokenized_stories_dir = "cnn_stories_tokenized"
# dm_tokenized_stories_dir = "dm_stories_tokenized"
finished_files_dir = "finished_files_twitter_inconsistent_3m10"    # 生成的.bin .pkl文件存放的位置
...
def write_to_bin(out_file, makevocab=False):    # 将txt写成.bin的格式
    ...
    if makevocab:
        ...
        print("vocab size:", len(vocab_counter))
