...
tokenized_twitter_dir = "twitter_test_select500gen"    # 分词后存的路径
# cnn_tokenized_stories_dir = "cnn_stories_tokenized"
# dm_tokenized_stories_dir = "dm_stories_tokenized"
finished_files_dir = "finished_files_select500"    # 生成的.bin .pkl文件存放的位置
...
VOCAB_SIZE = 200000
CHUNK_SIZE = 1  # num examples per chunk, for the chunked data , that is, a timeline
...
def get_art_abs(story_file):     # 单个.story文件的处理
    ...
    lines = [clean_str(line.lower()) for line in lines]   # 每个都处理成小写字母
