...
if __name__ == '__main__':
    ...
    clf = LogisticRegression(max_iter=5000, solver='liblinear', multi_class='ovr', penalty='l2', class_weight='balanced', random_state=9)
    clf.fit(X_train, y_train)
    time_3 = time.time()
    print('training cost %f seconds' % (time_3 - time_2))
    joblib.dump(clf, "LR1_model.m")
