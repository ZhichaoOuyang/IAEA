...
import BuildModelForTweet_nopos_concat as BuildModel
...
if __name__ == "__main__":
    ...
    checkpoint1 = ModelCheckpoint(filepath='best_model_1_50_nopos_concat_8m6.h5', monitor='val_acc', mode='auto', save_best_only='True')
    checkpoint2 = ModelCheckpoint(filepath='best_model_22_50_nopos_concat_8m6.h5', monitor='val_acc', mode='auto', save_best_only='True')
    ...
    if L1_model == 2:
        ...
        mp = "model1_50_nopos_concat_8m6.h5"
        model.save(mp)
    ...
    if L2_model == 2:
        ...
        model2.fit({'x1_input': content1_L2_Train[1], 'x2_input': content2_L2_Train[1]}, L2_Train[1],
                      ...
                      callbacks=callback_lists)
        print("Saving model to disk \n")
        mp = "model22_50_nopos_concat_8m6.h5"
        model2.save(mp)
