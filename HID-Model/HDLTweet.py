...
import Data_helper_Tweet_npyload as Data_helper
import BuildModelForTweet as BuildModel
...
if __name__ == "__main__":
    ...
    checkpoint1 = ModelCheckpoint(filepath='best_model_1_1000.h5', monitor='val_loss', mode='auto', save_best_only='True')
    checkpoint2 = ModelCheckpoint(filepath='best_model_22_1000.h5', monitor='val_loss', mode='auto', save_best_only='True')
